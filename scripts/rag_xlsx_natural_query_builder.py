...
DEFAULT_XLSX_V2 = Path("eval/gold_queries_xlsx_v2.csv")
...
DEFAULT_NATURALIZED_CSV = Path("eval/gold_queries_xlsx_v3_naturalized.csv")
DEFAULT_POSITIVE_CSV = Path("eval/gold_queries_xlsx_v3_positive.csv")
DEFAULT_BUILD_REPORT = Path("reports/rag_xlsx_natural_query_build_report.json")
DEFAULT_POSITIVE_EXPORT_REPORT = Path("reports/rag_xlsx_v3_positive_export_report.json")
