...
DEFAULT_V2_REPORT = Path("reports/rag_retrieval_eval_xlsx_vector_diagnostic_report.json")
DEFAULT_V3_REPORT = Path("reports/rag_retrieval_eval_xlsx_v3_positive_vector_diagnostic_report.json")
DEFAULT_V3_GOLD = Path("eval/gold_queries_xlsx_v3_positive.csv")
DEFAULT_QUALITY_AUDIT = Path("reports/rag_xlsx_natural_query_quality_audit.json")
DEFAULT_FORMULA_DATE_REVIEW = Path("reports/rag_xlsx_formula_date_contract_review.json")
DEFAULT_CHUNK_REVIEW = Path("reports/rag_xlsx_chunk_granularity_review.json")
DEFAULT_OUTPUT = Path("reports/rag_xlsx_v3_failure_breakdown.json")
