...
DEFAULT_REVIEWED_GOLD = Path("eval/gold_queries_xlsx_v3_positive_reviewed.csv")
...
DEFAULT_REVIEWED_REPORT = Path("reports/rag_retrieval_eval_xlsx_v3_positive_reviewed_vector_diagnostic_report.json")
DEFAULT_PATCH_PLAN = Path("reports/rag_xlsx_query_surface_patch_plan.json")
DEFAULT_COMPARE_OUTPUT = Path("reports/rag_xlsx_v3_query_surface_before_after_compare.json")
