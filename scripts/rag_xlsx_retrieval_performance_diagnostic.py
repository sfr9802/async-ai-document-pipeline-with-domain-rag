...
XLSX_CANDIDATE_ARTIFACT_DIR = Path("rag-data-xlsx-candidate-v1")

DEFAULT_V3_POSITIVE_GOLD = Path("eval/gold_queries_xlsx_v3_positive.csv")
DEFAULT_V3_NATURALIZED_GOLD = Path("eval/gold_queries_xlsx_v3_naturalized.csv")
DEFAULT_V2_GOLD = Path("eval/gold_queries_xlsx_v2.csv")
DEFAULT_FALLBACK_POSITIVE_GOLD = Path("eval/gold_queries_xlsx_v3_positive_diagnostic_from_v2.csv")
DEFAULT_REPORT = Path("reports/rag_retrieval_eval_xlsx_v3_positive_vector_diagnostic_report.json")
DEFAULT_SUMMARY = Path("reports/rag_xlsx_v3_retrieval_performance_summary.json")
DEFAULT_HIDDEN_REPORT = Path("reports/rag_xlsx_hidden_negative_leakage_diagnostic.json")
