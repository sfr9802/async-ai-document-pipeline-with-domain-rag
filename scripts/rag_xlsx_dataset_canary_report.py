...
MANIFEST_PATH = ROOT / "samples" / "rag_ingestion_hardened_xlsx_manifest.json"
REPORT_PATH = ROOT / "reports" / "rag_xlsx_additional_dataset_canary_report.json"

DATASETS = {
    "election_turnout_20200415": {
        "requested_name": "중앙선거관리위원회_제21대 국회의원선거 투표율 분석_20200415",
        "root": Path("datasets/xlsx/중앙선거관리위원회_제21대 국회의원선거 투표율 분석_20200415"),
    ...
    "employment_sentiment_20201229": {
        ...
        "root": Path("datasets/xlsx/국가데이터처_인공지능 학습을 위한 고용기사 감성지수 라벨링 데이터_20201229"),
        "domain": "employment news sentiment labels",
    },
    "surgery_statistics_2024": {
        "requested_name": "2024_주요수술통계연보(한글,_엑셀)",
        "root": Path("datasets/xlsx/2024_주요수술통계연보(한글,_엑셀)"),
