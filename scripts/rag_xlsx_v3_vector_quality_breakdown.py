...
DEFAULT_V3_RETRIEVAL_REPORT = Path("reports/rag_retrieval_eval_xlsx_v3_positive_vector_diagnostic_report.json")
DEFAULT_V2_RETRIEVAL_REPORT = Path("reports/rag_retrieval_eval_xlsx_vector_diagnostic_report.json")
...
DEFAULT_OUTPUT = Path("reports/rag_xlsx_v3_vector_quality_breakdown.json")
