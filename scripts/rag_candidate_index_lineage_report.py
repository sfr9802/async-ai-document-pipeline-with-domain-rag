...
DEFAULT_OUTPUT = Path("reports/rag_candidate_index_lineage_report.json")
...
DEFAULT_BASELINE_ARTIFACT_DIR = Path("rag-data-canary")
DEFAULT_XLSX_CANDIDATE_ARTIFACT_DIR = Path("rag-data-xlsx-candidate-v1")
DEFAULT_XLSX_SCOPE_REPORT = Path("reports/xlsx_candidate_scope_report.json")
DEFAULT_XLSX_INDEXING_REPORT = Path("reports/xlsx_candidate_indexing_report.json")
DEFAULT_XLSX_CONSISTENCY_REPORT = Path("reports/xlsx_candidate_embedding_consistency_report.json")
DEFAULT_XLSX_DIAGNOSTIC_REPORT = Path("reports/rag_retrieval_eval_xlsx_vector_diagnostic_report.json")
DEFAULT_FULL72_DIAGNOSTIC_REPORT = Path("reports/rag_retrieval_eval_full72_vector_diagnostic_report.json")
DEFAULT_MIXED_CONSISTENCY_REPORT = Path("reports/pdf_xlsx_candidate_embedding_consistency_report.json")
