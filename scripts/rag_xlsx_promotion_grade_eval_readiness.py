...
DEFAULT_OUTPUT = Path("reports/rag_xlsx_promotion_grade_eval_readiness.json")
DEFAULT_LINEAGE_REPORT = Path("reports/rag_candidate_index_lineage_report.json")
DEFAULT_REVIEW_DECISIONS = Path("reports/rag_xlsx_query_evidence_review_decisions.json")
DEFAULT_CONSISTENCY_REPORT = Path("reports/xlsx_candidate_embedding_consistency_report.json")
DEFAULT_SCOPE_REPORT = Path("reports/xlsx_candidate_scope_report.json")
