...
DEFAULT_METRICS = Path("reports/rag_ingestion_a5_promotion_gate_metrics.json")
DEFAULT_OUTPUT = Path("reports/a5_c2_source_qualified_report_contract_readiness.json")
