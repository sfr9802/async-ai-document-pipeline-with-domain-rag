...
DEFAULT_QUERY_SURFACE_PLAN = Path("reports/rag_xlsx_query_surface_patch_plan.json")
DEFAULT_RANGE_POLICY_REVIEW = Path("reports/rag_xlsx_range_policy_review.json")
DEFAULT_FORMULA_DATE_REVIEW = Path("reports/rag_xlsx_formula_date_contract_review.json")
DEFAULT_OUTPUT = Path("reports/xlsx_candidate_v2_decision.json")
