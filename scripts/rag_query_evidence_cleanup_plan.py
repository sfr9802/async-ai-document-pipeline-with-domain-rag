...
DEFAULT_BREAKDOWN = Path("reports/rag_retrieval_full72_vector_quality_breakdown.json")
DEFAULT_GOLD = Path("eval/gold_queries_v0.csv")
DEFAULT_OUTPUT = Path("reports/rag_full72_query_evidence_cleanup_plan.json")
