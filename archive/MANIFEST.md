...
| `legacy-note` | Legacy documentation or migration note | Historical provenance only; active instructions should live outside archive. |
| `frontend-handoff` | Historical frontend design handoff or legacy UI bundle | Reference only; active app code stays under `frontend/app/`. |
...
|---|---|---|---|---|---|
| `ai-worker/eval/legacy/v3/README.md` | `archive/experiments/eval-legacy/v3/README.md` | legacy-note | no | low | Legacy v3 eval note only; no tracked code or tests referenced this path. |
| `frontend/AI _ _ Design System/` | `archive/experiments/frontend-design-system/AI _ _ Design System/` | frontend-handoff | no | low | Historical frontend design-system handoff export; active frontend remains under `frontend/app/`. |
| `frontend/AI _ _ Design System (1)/` | `archive/experiments/frontend-design-system/AI _ _ Design System (1)/` | frontend-handoff | no | low | Historical frontend design handoff duplicate/export; active frontend remains under `frontend/app/`. |
| `frontend/index.legacy.html` | `archive/experiments/frontend-legacy/index.legacy.html` | frontend-handoff | no | low | Legacy static frontend bundle; active frontend entry remains `frontend/index.html` and `frontend/app/`. |
| `ai-worker/eval/legacy_agent_loop_ab/` | `../_external_workspace_archive/async-ocr-rag-multimodal-pipeline/2026-05-11-portfolio-cleanup/ai-worker/eval/legacy_agent_loop_ab/` | eval-dry-run | no | low | Git-ignored legacy smoke CSV/JSONL residue moved outside the repository instead of newly tracking ignored data. |
