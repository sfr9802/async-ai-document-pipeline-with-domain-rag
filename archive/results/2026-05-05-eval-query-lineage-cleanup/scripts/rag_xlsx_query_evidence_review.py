...
DEFAULT_CLEANUP_PLAN = Path("eval/reports/rag-ingestion/rag_xlsx_query_evidence_cleanup_plan.json")
DEFAULT_RETRIEVAL_REPORT = Path("eval/reports/rag-ingestion/rag_retrieval_eval_xlsx_vector_diagnostic_report.json")
DEFAULT_GOLD = Path("eval/eval_queries/gold_queries_v0.csv")
DEFAULT_OUTPUT = Path("eval/reports/rag-ingestion/rag_xlsx_query_evidence_review_decisions.json")
    ...
    return (
        {
            ...
            "rerun_preparation": {
                "diagnostic_only_command": [
                    ...
                    "10",
                    "--report",
                    "eval/reports/rag-ingestion/rag_retrieval_eval_xlsx_v1_vector_diagnostic_report.json",
                ],
                "promotion_evidence": False,
            ...
            "notes": [
                ...
                "eval/eval_queries/gold_queries_xlsx_v1.csv contains only promotion_eval_eligible=true rows.",
