...
DEFAULT_CLEANUP_PLAN = Path("eval/reports/rag-ingestion/rag_full72_query_evidence_cleanup_plan.json")
DEFAULT_METRICS_REPORT = Path("eval/reports/rag-ingestion/rag_ingestion_a5_promotion_gate_metrics.json")
DEFAULT_SOURCE_QUALIFIED_READINESS_REPORT = Path("eval/reports/rag-ingestion/a5_c2_source_qualified_report_contract_readiness.json")
DEFAULT_CONSISTENCY_REPORT = Path("eval/reports/rag-ingestion/pdf_xlsx_candidate_embedding_consistency_report.json")
DEFAULT_CANDIDATE_SCOPE_REPORT = Path("eval/reports/rag-ingestion/rag_candidate_scope_path_readiness.json")
DEFAULT_C3_READINESS_REPORT = Path("eval/reports/rag-ingestion/a5_c3_immutable_baseline_readiness.json")
DEFAULT_GATE_REPORT = Path("eval/reports/rag-ingestion/rag_ingestion_a5_promotion_gate_report.json")
DEFAULT_OUTPUT = Path("eval/reports/rag-ingestion/rag_promotion_grade_vector_eval_readiness.json")
