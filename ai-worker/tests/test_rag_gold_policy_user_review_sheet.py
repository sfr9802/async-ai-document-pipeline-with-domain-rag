...
SCRIPT_PATH = ROOT / "ai-worker" / "scripts" / "rag_gold_policy_user_review_sheet.py"
...
def fixture_draft(module) -> dict:
    ...
    return {
        "status": "PASS",
        "source_resolution_packet": {"json_path": "ai-worker/eval/review/rag_gold_policy_resolution_packet_v1.json"},
        "guardrail_status": {
