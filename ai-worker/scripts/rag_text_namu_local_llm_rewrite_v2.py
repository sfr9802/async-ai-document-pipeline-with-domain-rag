...
REVIEW_DIR = ROOT / "ai-worker" / "eval" / "review"
REPORT_DIR = ROOT / "ai-worker" / "eval" / "reports" / "rag-ingestion"
OFFICIAL_DENOMINATOR_REGISTRY = ROOT / "ai-worker" / "eval" / "eval_queries" / "official_denominator_registry.json"
