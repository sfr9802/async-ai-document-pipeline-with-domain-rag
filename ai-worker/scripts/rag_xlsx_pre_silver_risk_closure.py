...
OFFICIAL_REGISTRY = ROOT / "ai-worker" / "eval" / "eval_queries" / "official_denominator_registry.json"
...
CURRENT_NORMALIZED_REPO_PATH = "ai-worker/eval/eval_queries/gold_queries_xlsx_human_review_normalized_v0.csv"
CURRENT_OFFICIAL_REPO_PATH = "ai-worker/eval/eval_queries/gold_queries_xlsx_human_review_official_positive_v0.csv"
...
CURRENT_NORMALIZATION_REPORT_REPO_PATH = (
    "ai-worker/eval/reports/rag-ingestion/rag_xlsx_human_review_gold_normalization_report.json"
)
