...
SOURCE_DATASET = "ai-worker/eval/corpora/namu-v4-structured-combined"
SOURCE_ORIGINAL_GOLD = "ai-worker/eval/eval_queries/gold_queries_text_namu_v4_v0.csv"
SOURCE_SILVER_MANUAL = (
    "ai-worker/eval/reports/phase7/7.12_silver_manual_curated/"
...
def run_build(
    *,
    ...
    summary = {
        ...
        "commands": {
            "build": (
                "python ai-worker/scripts/rag_text_namu_v2_gold_review_workflow.py "
                "--mode build"
            ),
            "validate_review_pack": (
                "python ai-worker/scripts/rag_text_namu_v2_gold_review_workflow.py "
                "--mode validate --review-pack "
                "ai-worker/eval/review/text_namu_v2_gold_review/text_namu_v2_gold_review_pack.csv"
            ),
        },
        "limitations": [
...
def write_markdown_report(path: Path, summary: Mapping[str, Any], audit: Mapping[str, Any]) -> None:
    ...
    lines.extend(
        [
            ...
            "",
            "```powershell",
            "python ai-worker/scripts/rag_text_namu_v2_gold_review_workflow.py --mode build",
            "python ai-worker/scripts/rag_text_namu_v2_gold_review_workflow.py --mode validate --review-pack ai-worker/eval/review/text_namu_v2_gold_review/text_namu_v2_gold_review_pack.csv",
            "python -m pytest -q ai-worker/tests/test_rag_text_namu_v2_gold_review_workflow.py ai-worker/tests/test_rag_text_namu_v4_gold_validator.py",
            "```",
            "",
            "## Limitations",
            "",
