...
DEFAULT_INDEX_DIR = Path("eval/indexes/rag-data-canary")
DEFAULT_CONSISTENCY_REPORT = Path("eval/reports/rag-ingestion/pdf_xlsx_candidate_embedding_consistency_report.json")
DEFAULT_SCOPE_READINESS_REPORT = Path("eval/reports/rag-ingestion/rag_candidate_scope_path_readiness.json")
DEFAULT_DESCRIPTOR = Path("eval/reports/rag-ingestion/initial_immutable_vector_baseline_descriptor.json")
DEFAULT_READINESS = Path("eval/reports/rag-ingestion/initial_baseline_bootstrap_readiness.json")
