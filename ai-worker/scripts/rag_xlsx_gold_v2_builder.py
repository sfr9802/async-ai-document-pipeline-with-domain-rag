...
DEFAULT_GOLD_V0 = Path("eval/eval_queries/gold_queries_v0.csv")
...
DEFAULT_INGEST_MANIFEST = Path("eval/indexes/rag-data-xlsx-candidate-v1/ingest_manifest.json")
DEFAULT_OUTPUT_CSV = Path("eval/eval_queries/gold_queries_xlsx_v2.csv")
DEFAULT_BUILD_REPORT = Path("eval/reports/rag-ingestion/rag_xlsx_gold_v2_build_report.json")
