...
DEFAULT_CANDIDATE_SCOPE_READINESS = Path("eval/reports/rag-ingestion/rag_candidate_scope_path_readiness.json")
DEFAULT_GLOBAL_PATH_HYGIENE = Path("eval/reports/rag-ingestion/rag_path_separation_readiness.json")
DEFAULT_OUTPUT = Path("eval/reports/rag-ingestion/rag_retrieval_full72_vector_quality_breakdown.json")
