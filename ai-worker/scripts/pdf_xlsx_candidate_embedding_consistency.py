...
DEFAULT_OUTPUT = Path("eval/reports/rag-ingestion/pdf_xlsx_candidate_embedding_consistency_report.json")
DEFAULT_GOLD_QUERY_FILE = Path("eval/eval_queries/gold_queries_v0.csv")
