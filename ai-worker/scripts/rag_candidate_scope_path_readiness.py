...
DEFAULT_OUTPUT = Path("eval/reports/rag-ingestion/rag_candidate_scope_path_readiness.json")
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--global-report", default="eval/reports/rag-ingestion/rag_path_separation_readiness.json")
