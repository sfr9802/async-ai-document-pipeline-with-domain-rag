...
DEFAULT_PRE_SILVER_REPORT = ROOT / "ai-worker" / "eval" / "reports" / "rag-ingestion" / "xlsx_pre_silver_risk_closure_20260507.json"
DEFAULT_OUTPUT_DIR = ROOT / "ai-worker" / "eval" / "eval_queries"
DEFAULT_REPORT_DIR = ROOT / "ai-worker" / "eval" / "reports" / "rag-ingestion"
...
def verify_preconditions(*, pre_silver_report: Path, registry_path: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "strict_wrapper": {
            ...
            "retrieval_backend": "vector",
            "namespace": XLSX_CANDIDATE_NAMESPACE,
            "positive_gold": "ai-worker/" + CURRENT_XLSX_RETRIEVAL_GOLD.as_posix(),
    ...
    *,
    ...
    return {
        ...
        "source_artifact_identifiers": {
            ...
            "index_build": artifact_entry(ROOT / "ai-worker" / XLSX_CANDIDATE_INDEX_DIR / "build.json"),
            "index_ingest_manifest": artifact_entry(ROOT / "ai-worker" / XLSX_CANDIDATE_INDEX_DIR / "ingest_manifest.json"),
        },
        ...
        "official_denominator_registry_diff": {
            "path": "ai-worker/eval/eval_queries/official_denominator_registry.json",
