...
SCRIPT_PATH = ROOT / "ai" / "scripts" / "rag_xlsx_strict_silver_generation.py"
REGISTRY_PATH = ROOT / "ai" / "eval" / "eval_queries" / "official_denominator_registry.json"
...
def test_strict_silver_report_uses_approved_wrapper_and_23_rows():
    ...
    assert all(
        row["strict_wrapper_path"] == "ai/scripts/rag_xlsx_retrieval_performance_diagnostic.py"
