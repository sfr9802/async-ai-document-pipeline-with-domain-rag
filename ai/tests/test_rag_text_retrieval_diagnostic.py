...
MODULE_PATH = ROOT / "ai" / "scripts" / "rag_text_retrieval_diagnostic.py"
...
def test_build_report_keeps_diagnostic_flags_and_done_criteria():
    ...
    report = diag.build_report(
        gold=ROOT / "ai" / "eval" / "eval_queries" / "gold_queries_text_e2e_v0.csv",
        rows=rows,
        ...
        backend_identity_report_path=ROOT / "ai" / "eval" / "reports" / "rag-ingestion" / "rag_text_backend_identity_report.json",
