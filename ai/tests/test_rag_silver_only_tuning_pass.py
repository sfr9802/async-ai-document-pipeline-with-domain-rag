...
SCRIPT_PATH = ROOT / "ai" / "scripts" / "rag_silver_only_tuning_pass.py"
DIAG_SCRIPT_PATH = ROOT / "ai" / "scripts" / "rag_silver_tuning_diagnostic_analysis.py"
PDF_HNEG_V2_SCRIPT_PATH = ROOT / "ai" / "scripts" / "rag_pdf_file_lookup_hard_negative_v2.py"
