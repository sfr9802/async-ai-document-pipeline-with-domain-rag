...
def _preview_diagnostics(response: RagDiagnosticQueryResponse) -> dict[str, Any]:
    return {
        ...
        "source_family_adjudicator_called": response.source_family_adjudicator_called,
        "source_family_adjudicator_status": response.source_family_adjudicator_status,
        "source_family_adjudicator_output": _sanitize_for_preview(response.source_family_adjudicator_output),
        "resolved_source_family": response.resolved_source_family,
