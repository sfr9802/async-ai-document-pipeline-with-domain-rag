...
REQUIRED_PATHS = [
    ...
    "ai/eval/configs/answer_recovery_safe_recall_missed_row_triage.yaml",
    "ai/eval/configs/answer_recovery_embedding_readiness.yaml",
    "ai/eval/configs/answer_recovery_fresh_diagnostic_candidate_discovery.yaml",
    "ai/eval/configs/answer_recovery_optuna_round_01_config.yaml",
]
...
def official_registry_diff_proof() -> dict[str, Any]:
    rel = "ai/eval/eval_queries/official_denominator_registry.json"
