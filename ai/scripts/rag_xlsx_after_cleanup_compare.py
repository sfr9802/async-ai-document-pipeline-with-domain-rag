...
DEFAULT_BEFORE_REPORT = Path("reports/rag_eval/rag-ingestion/rag_retrieval_eval_xlsx_v3_positive_vector_diagnostic_report.json")
DEFAULT_AFTER_REPORT = Path("reports/rag_eval/rag-ingestion/rag_retrieval_eval_xlsx_v3_positive_reviewed_vector_diagnostic_report.json")
...
DEFAULT_HIDDEN_REPORT = Path("reports/rag_eval/rag-ingestion/rag_xlsx_v3_positive_reviewed_hidden_negative_leakage_diagnostic.json")
DEFAULT_CANDIDATE_DECISION = Path("reports/rag_eval/rag-ingestion/xlsx_candidate_v2_decision.json")
DEFAULT_OUTPUT = Path("reports/rag_eval/rag-ingestion/rag_xlsx_v3_after_cleanup_metric_compare.json")
