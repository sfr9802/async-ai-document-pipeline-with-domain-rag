"""One-command demo for the AI processing platform.
    ...
    python scripts/demo.py                              # compatibility wrapper
    python scripts/operational/demo.py                  # canonical path
    python scripts/operational/demo.py --capability OCR # OCR-only demo
    python scripts/operational/demo.py --self-test      # offline sanity check
...
Prerequisites (for the full demo, not --self-test):
  ...
  - ai running with at least OCR + RAG capabilities
