...
CANONICAL_CURRENT_REPORTS = [
    "reports/rag_eval/rag-ingestion/three_track_metric_preflight_board.json",
    "reports/rag_eval/rag-ingestion/three_track_metric_preflight_board.md",
    "reports/rag_eval/rag-ingestion/hyperparameter_tuning_readiness_plan.json",
    "reports/rag_eval/rag-ingestion/hyperparameter_tuning_readiness_plan.md",
    "reports/rag_eval/rag-ingestion/report_only_tuning_dry_run_plan_v1.json",
    "reports/rag_eval/rag-ingestion/report_only_tuning_dry_run_plan_v1.md",
    "reports/rag_eval/rag-ingestion/official_metric_transition_readiness_checklist_v1.json",
    "reports/rag_eval/rag-ingestion/official_metric_transition_readiness_checklist_v1.md",
    ...
    "reports/rag_eval/rag-ingestion/official_denominator_candidate_diff_preview_v1.json",
    "reports/rag_eval/rag-ingestion/official_denominator_candidate_diff_preview_v1.md",
    "reports/rag_eval/rag-ingestion/official_question_gold_v2_registry_application_report.json",
    "reports/rag_eval/rag-ingestion/official_question_gold_v2_registry_application_report.md",
    "reports/rag_eval/rag-ingestion/metric_input_v1.json",
    "reports/rag_eval/rag-ingestion/metric_input_v1.md",
    "docs/rag-ingestion-progress.md",
]

SOURCE_PROOF_REPORTS = [
    "reports/rag_eval/rag-ingestion/rag_xlsx_answer_citation_policy_review_packet_v1.json",
    "reports/rag_eval/rag-ingestion/rag_pdf_answer_citation_policy_review_packet_v1.json",
    "reports/rag_eval/rag-ingestion/pdf_evidence_metadata_enrichment_report.json",
    "reports/rag_eval/rag-ingestion/pdf_layout_gap_closure_report.json",
    "reports/rag_eval/rag-ingestion/pdf_evidence_readiness_repair_report.json",
