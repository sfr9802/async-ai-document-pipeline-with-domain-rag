...
SOURCE_DIRECTORIES = [
    "ai/eval/datasets/elec",
    "ai/eval/datasets/lh",
]

PROTECTED_SOURCE_SHA256: dict[str, str] = {
    "ai/eval/eval_queries/gold_queries_pdf_v0.csv": "cf582fbf0629962ba035ad121d4e9dd7fbea2ee4b7251c51dce2a0a31ea22e29",
    "ai/eval/eval_queries/gold_queries_pdf_v1_review_draft.csv": "5bea29e2ba1bd1787e37afdfd4c42b350773eb8ebab87a4041f280ab45f9b694",
}
PROTECTED_REGISTRY_PATHS = {"ai/eval/eval_queries/official_denominator_registry.json"}
