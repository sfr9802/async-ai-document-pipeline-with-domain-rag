...
Outputs land under
``reports/rag_eval/_archive/confirm-runs/retrieval-full-silver-minimal-<TIMESTAMP>/``.
The run never overwrites the legacy historical baseline at
``reports/rag_eval/legacy-baseline-final/`` or the phase2/2a_latency artifacts.
