...
Usage::
    ...
    python -m scripts.run_phase7_4_controlled_recovery \\
        --confidence-jsonl reports/rag_eval/phase7/7.3_confidence_eval/per_query_confidence.jsonl \\
        --per-query        reports/rag_eval/phase7/7.0_retrieval_title_ab/per_query_comparison.jsonl \\
        --chunks           reports/rag_eval/phase7/7.0_retrieval_title_ab/rag_chunks_retrieval_title_section.jsonl \\
        --silver-queries   reports/rag_eval/phase7/7.0_retrieval_title_ab/queries_v4_silver.jsonl \\
        --report-dir       reports/rag_eval/phase7/7.4_controlled_recovery/ \\
        --rewrite-mode     both
