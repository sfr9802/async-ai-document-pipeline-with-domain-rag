...
def validate_static_contract(
    *,
    ...
    if display_path(artifact_dir) != "ai/eval/indexes/rag-data-pdf-candidate-v1":
        blockers.append("C5 artifact_dir must be ai/eval/indexes/rag-data-pdf-candidate-v1")
