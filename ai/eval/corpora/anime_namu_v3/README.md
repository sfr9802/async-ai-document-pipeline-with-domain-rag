...
query 는 [`ai/eval/eval_queries/`](../../eval_queries/) 에 있음.
...
cp 'D:/port/rag/app/scripts/namu_anime_v3.jsonl' \
   ai/eval/corpora/anime_namu_v3/corpus.jsonl
```

위 경로에서 출처를 더 이상 사용할 수 없으면, namu-wiki dump 에서
`D:/port/rag/app/scripts/build_with_subpages.fixed.py` 로 재생성하거나,
[`ai/fixtures/anime_corpus_kr.jsonl`](../../../fixtures/anime_corpus_kr.jsonl)
...
이 분포는
[`ai/eval/harness/generate_eval_queries.py`](../../harness/generate_eval_queries.py)
