...
- `.gitignore`
- `ai/app/capabilities/rag_orchestrator/graph.py`
- `ai/app/capabilities/rag_orchestrator/state.py`
- `ai/app/capabilities/rag_orchestrator/capability.py`
- `ai/app/capabilities/rag_orchestrator/tools.py`
- `ai/app/capabilities/rag_orchestrator/vector_tools.py`
- `ai/app/capabilities/rag_orchestrator/xlsx_tools.py`
- `ai/app/capabilities/rag_orchestrator/pdf_tools.py`
- `ai/eval/harness/rag_ingestion_retrieval_eval.py`
- `ai/scripts/rag_query_intent_routing_matrix.py`
- `ai/scripts/rag_xlsx_retrieval_performance_diagnostic.py`
- `ai/tests/test_rag_query_orchestrator_graph.py`
- `ai/tests/test_rag_query_orchestrator_capability.py`
- `ai/tests/test_rag_query_orchestrator_vector_tools.py`
- `ai/tests/test_retrieval_eval_harness.py`
- `ai/tests/test_rag_query_intent_routing_matrix.py`
- `docs/rag-ingestion-progress.md`
- `ai/eval/reports/rag-ingestion/three_track_orchestration_report.md`

Later cleanup externalized the retired track README/report-index files; current
navigation lives in the root README and `docs/rag-ingestion-progress.md`.
