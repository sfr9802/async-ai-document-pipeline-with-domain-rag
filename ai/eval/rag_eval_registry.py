...
V5_7_VECTOR_LLM_CANDIDATE_ROUTING_SHORT_KEY = "v5_7_vector_llm_candidate_routing"
V5_7_VECTOR_LLM_CANDIDATE_ROUTING_SHORT_RUN_ID = (
    "v5_7_vector_llm_candidate_routing_with_regression_remediation_diagnostic_nonprod"
)
V5_7_VECTOR_LLM_CANDIDATE_ROUTING_LONG_RUN_ID = V5_7_VECTOR_LLM_CANDIDATE_ROUTING_SHORT_RUN_ID
V5_7_VECTOR_LLM_CANDIDATE_ROUTING_STATUS = (
    "V5_7_VECTOR_LLM_CANDIDATE_ROUTING_WITH_REGRESSION_REMEDIATION_DIAGNOSTIC_NONPROD_READY"
)
V5_7_1_RETRIEVAL_METRIC_INTEGRITY_AUDIT_SHORT_KEY = "v5_7_1_retrieval_metric_integrity_audit"
V5_7_1_RETRIEVAL_METRIC_INTEGRITY_AUDIT_SHORT_RUN_ID = (
    "v5_7_1_retrieval_metric_integrity_audit_diagnostic_nonprod"
)
V5_7_1_RETRIEVAL_METRIC_INTEGRITY_AUDIT_LONG_RUN_ID = (
    V5_7_1_RETRIEVAL_METRIC_INTEGRITY_AUDIT_SHORT_RUN_ID
)
V5_7_1_RETRIEVAL_METRIC_INTEGRITY_AUDIT_STATUS = (
    "V5_7_1_RETRIEVAL_METRIC_INTEGRITY_AUDIT_DIAGNOSTIC_NONPROD_READY"
)
V5_7_2_LIVE_RETRIEVAL_DENOMINATOR_EXPANSION_SHORT_KEY = (
    "v5_7_2_live_retrieval_denominator_and_row_expansion"
)
V5_7_2_LIVE_RETRIEVAL_DENOMINATOR_EXPANSION_SHORT_RUN_ID = (
    "v5_7_2_live_retrieval_denominator_and_row_expansion_diagnostic_nonprod"
)
V5_7_2_LIVE_RETRIEVAL_DENOMINATOR_EXPANSION_LONG_RUN_ID = (
    V5_7_2_LIVE_RETRIEVAL_DENOMINATOR_EXPANSION_SHORT_RUN_ID
)
V5_7_2_LIVE_RETRIEVAL_DENOMINATOR_EXPANSION_STATUS = (
    "V5_7_2_LIVE_RETRIEVAL_DENOMINATOR_AND_ROW_EXPANSION_DIAGNOSTIC_NONPROD_READY"
)
V5_8_RETRIEVAL_METRIC_EVALUATION_FRAMEWORK_SHORT_KEY = "v5_8_retrieval_metric_evaluation_framework"
V5_8_RETRIEVAL_METRIC_EVALUATION_FRAMEWORK_SHORT_RUN_ID = (
    "v5_8_retrieval_metric_evaluation_framework_diagnostic_nonprod"
)
V5_8_RETRIEVAL_METRIC_EVALUATION_FRAMEWORK_LONG_RUN_ID = (
    V5_8_RETRIEVAL_METRIC_EVALUATION_FRAMEWORK_SHORT_RUN_ID
)
V5_8_RETRIEVAL_METRIC_EVALUATION_FRAMEWORK_STATUS = (
    "V5_8_RETRIEVAL_METRIC_EVALUATION_FRAMEWORK_DIAGNOSTIC_NONPROD_READY"
)
V6_0_TRUE_RAG_RETRIEVAL_REWRITE_SHORT_KEY = "v6_0_true_rag_retrieval_rewrite"
V6_0_TRUE_RAG_RETRIEVAL_REWRITE_SHORT_RUN_ID = "v6_0_true_rag_retrieval_rewrite"
V6_0_TRUE_RAG_RETRIEVAL_REWRITE_LONG_RUN_ID = V6_0_TRUE_RAG_RETRIEVAL_REWRITE_SHORT_RUN_ID
V6_0_TRUE_RAG_RETRIEVAL_REWRITE_STATUS = "V6_0_TRUE_RAG_RETRIEVAL_REWRITE_DIAGNOSTIC_NONPROD_READY"
V6_0_AGENTIC_TRUE_RAG_TOOL_LOOP_SHORT_KEY = "v6_0_agentic_true_rag_and_tool_loop_rewrite"
V6_0_AGENTIC_TRUE_RAG_TOOL_LOOP_SHORT_RUN_ID = "v6_0_agentic_true_rag_and_tool_loop_rewrite"
V6_0_AGENTIC_TRUE_RAG_TOOL_LOOP_LONG_RUN_ID = V6_0_AGENTIC_TRUE_RAG_TOOL_LOOP_SHORT_RUN_ID
V6_0_AGENTIC_TRUE_RAG_TOOL_LOOP_STATUS = "V6_0_AGENTIC_TRUE_RAG_AND_TOOL_LOOP_REWRITE_NONPROD_READY"
V6_1_TRUE_RAG_CORPUS_EXPANSION_METRIC_SPLIT_SHORT_KEY = (
    "v6_1_true_rag_corpus_expansion_and_metric_split_hardening"
)
V6_1_TRUE_RAG_CORPUS_EXPANSION_METRIC_SPLIT_SHORT_RUN_ID = (
    V6_1_TRUE_RAG_CORPUS_EXPANSION_METRIC_SPLIT_SHORT_KEY
)
V6_1_TRUE_RAG_CORPUS_EXPANSION_METRIC_SPLIT_LONG_RUN_ID = (
    V6_1_TRUE_RAG_CORPUS_EXPANSION_METRIC_SPLIT_SHORT_RUN_ID
)
V6_1_TRUE_RAG_CORPUS_EXPANSION_METRIC_SPLIT_STATUS = (
    "V6_1_TRUE_RAG_CORPUS_EXPANSION_AND_METRIC_SPLIT_HARDENING_NONPROD_READY"
)
V6_2_SOURCE_DERIVED_MATERIALIZATION_SCALEOUT_SHORT_KEY = (
    "v6_2_source_derived_materialization_scaleout_and_denominator_reality_check"
)
V6_2_SOURCE_DERIVED_MATERIALIZATION_SCALEOUT_SHORT_RUN_ID = (
    V6_2_SOURCE_DERIVED_MATERIALIZATION_SCALEOUT_SHORT_KEY
)
V6_2_SOURCE_DERIVED_MATERIALIZATION_SCALEOUT_LONG_RUN_ID = (
    V6_2_SOURCE_DERIVED_MATERIALIZATION_SCALEOUT_SHORT_RUN_ID
)
V6_2_SOURCE_DERIVED_MATERIALIZATION_SCALEOUT_STATUS = (
    "V6_2_SOURCE_DERIVED_MATERIALIZATION_SCALEOUT_DENOMINATOR_REALITY_CHECK_NONPROD_READY"
)
V6_3_E2E_BGE_M3_FAISS_AGENTIC_RAG_SMOKE_SHORT_KEY = (
    "v6_3_e2e_bge_m3_faiss_agentic_rag_smoke_single_report"
)
V6_3_E2E_BGE_M3_FAISS_AGENTIC_RAG_SMOKE_SHORT_RUN_ID = (
    V6_3_E2E_BGE_M3_FAISS_AGENTIC_RAG_SMOKE_SHORT_KEY
)
V6_3_E2E_BGE_M3_FAISS_AGENTIC_RAG_SMOKE_LONG_RUN_ID = (
    V6_3_E2E_BGE_M3_FAISS_AGENTIC_RAG_SMOKE_SHORT_RUN_ID
)
V6_3_E2E_BGE_M3_FAISS_AGENTIC_RAG_SMOKE_STATUS = (
    "V6_3_E2E_BGE_M3_FAISS_AGENTIC_RAG_SMOKE_SINGLE_REPORT_NONPROD_READY"
)
V6_4_E2E_COVERAGE_FAILURE_TAXONOMY_SHORT_KEY = "v6_4_e2e_coverage_and_failure_taxonomy_nonprod"
V6_4_E2E_COVERAGE_FAILURE_TAXONOMY_SHORT_RUN_ID = V6_4_E2E_COVERAGE_FAILURE_TAXONOMY_SHORT_KEY
V6_4_E2E_COVERAGE_FAILURE_TAXONOMY_LONG_RUN_ID = V6_4_E2E_COVERAGE_FAILURE_TAXONOMY_SHORT_RUN_ID
V6_4_E2E_COVERAGE_FAILURE_TAXONOMY_STATUS = "V6_4_E2E_COVERAGE_AND_FAILURE_TAXONOMY_NONPROD_READY"
V6_5_RETRIEVAL_METRIC_UNLOCK_PACKET_SHORT_KEY = "v6_5_retrieval_metric_unlock_packet_nonprod"
V6_5_RETRIEVAL_METRIC_UNLOCK_PACKET_SHORT_RUN_ID = V6_5_RETRIEVAL_METRIC_UNLOCK_PACKET_SHORT_KEY
V6_5_RETRIEVAL_METRIC_UNLOCK_PACKET_LONG_RUN_ID = V6_5_RETRIEVAL_METRIC_UNLOCK_PACKET_SHORT_RUN_ID
V6_5_RETRIEVAL_METRIC_UNLOCK_PACKET_STATUS = "V6_5_RETRIEVAL_METRIC_UNLOCK_PACKET_NONPROD_READY"
V6_5_1_GOLD29_ACTUAL_RESPONSE_SMOKE_SHORT_KEY = "v6_5_1_gold29_actual_response_smoke_nonprod"
V6_5_1_GOLD29_ACTUAL_RESPONSE_SMOKE_SHORT_RUN_ID = V6_5_1_GOLD29_ACTUAL_RESPONSE_SMOKE_SHORT_KEY
V6_5_1_GOLD29_ACTUAL_RESPONSE_SMOKE_LONG_RUN_ID = V6_5_1_GOLD29_ACTUAL_RESPONSE_SMOKE_SHORT_RUN_ID
V6_5_1_GOLD29_ACTUAL_RESPONSE_SMOKE_STATUS = "V6_5_1_GOLD29_ACTUAL_RESPONSE_SMOKE_NONPROD_READY"
V6_6_STRUCTURED_TOOL_OPERATION_TAXONOMY_SHORT_KEY = "v6_6_structured_tool_operation_taxonomy_nonprod"
V6_6_STRUCTURED_TOOL_OPERATION_TAXONOMY_SHORT_RUN_ID = V6_6_STRUCTURED_TOOL_OPERATION_TAXONOMY_SHORT_KEY
V6_6_STRUCTURED_TOOL_OPERATION_TAXONOMY_LONG_RUN_ID = V6_6_STRUCTURED_TOOL_OPERATION_TAXONOMY_SHORT_RUN_ID
V6_6_STRUCTURED_TOOL_OPERATION_TAXONOMY_STATUS = "V6_6_STRUCTURED_TOOL_OPERATION_TAXONOMY_NONPROD_READY"
V6_7_AGENTIC_RETRY_FAIL_CLOSED_POLICY_SHORT_KEY = "v6_7_agentic_retry_fail_closed_policy_nonprod"
V6_7_AGENTIC_RETRY_FAIL_CLOSED_POLICY_SHORT_RUN_ID = V6_7_AGENTIC_RETRY_FAIL_CLOSED_POLICY_SHORT_KEY
V6_7_AGENTIC_RETRY_FAIL_CLOSED_POLICY_LONG_RUN_ID = V6_7_AGENTIC_RETRY_FAIL_CLOSED_POLICY_SHORT_RUN_ID
V6_7_AGENTIC_RETRY_FAIL_CLOSED_POLICY_STATUS = "V6_7_AGENTIC_RETRY_FAIL_CLOSED_POLICY_NONPROD_READY"
V6_8_METRIC_GATED_RETRIEVAL_QUALITY_ENGINEERING_SHORT_KEY = "v6_8_metric_gated_retrieval_quality_engineering_nonprod"
V6_8_METRIC_GATED_RETRIEVAL_QUALITY_ENGINEERING_SHORT_RUN_ID = V6_8_METRIC_GATED_RETRIEVAL_QUALITY_ENGINEERING_SHORT_KEY
V6_8_METRIC_GATED_RETRIEVAL_QUALITY_ENGINEERING_LONG_RUN_ID = (
    V6_8_METRIC_GATED_RETRIEVAL_QUALITY_ENGINEERING_SHORT_RUN_ID
)
V6_8_METRIC_GATED_RETRIEVAL_QUALITY_ENGINEERING_STATUS = (
    "V6_8_METRIC_GATED_RETRIEVAL_QUALITY_ENGINEERING_NONPROD_READY"
)
V6_9_ANSWER_QUALITY_GATE_PACKET_SHORT_KEY = "v6_9_answer_quality_gate_packet_nonprod"
V6_9_ANSWER_QUALITY_GATE_PACKET_SHORT_RUN_ID = V6_9_ANSWER_QUALITY_GATE_PACKET_SHORT_KEY
V6_9_ANSWER_QUALITY_GATE_PACKET_LONG_RUN_ID = V6_9_ANSWER_QUALITY_GATE_PACKET_SHORT_RUN_ID
V6_9_ANSWER_QUALITY_GATE_PACKET_STATUS = "V6_9_ANSWER_QUALITY_GATE_PACKET_NONPROD_READY"
V6_9_1_RETRIEVAL_SMOKE_PRE_REVIEW_PACKET_SHORT_KEY = "v6_9_1_retrieval_smoke_pre_review_packet_nonprod"
V6_9_1_RETRIEVAL_SMOKE_PRE_REVIEW_PACKET_SHORT_RUN_ID = (
    V6_9_1_RETRIEVAL_SMOKE_PRE_REVIEW_PACKET_SHORT_KEY
)
V6_9_1_RETRIEVAL_SMOKE_PRE_REVIEW_PACKET_LONG_RUN_ID = (
    V6_9_1_RETRIEVAL_SMOKE_PRE_REVIEW_PACKET_SHORT_RUN_ID
)
V6_9_1_RETRIEVAL_SMOKE_PRE_REVIEW_PACKET_STATUS = (
    "V6_9_1_RETRIEVAL_SMOKE_PRE_REVIEW_PACKET_NONPROD_READY"
)
V7_0_E2E_EVAL_ARCHITECTURE_CLOSEOUT_SHORT_KEY = "v7_0_e2e_eval_architecture_closeout_nonprod"
V7_0_E2E_EVAL_ARCHITECTURE_CLOSEOUT_SHORT_RUN_ID = V7_0_E2E_EVAL_ARCHITECTURE_CLOSEOUT_SHORT_KEY
V7_0_E2E_EVAL_ARCHITECTURE_CLOSEOUT_LONG_RUN_ID = V7_0_E2E_EVAL_ARCHITECTURE_CLOSEOUT_SHORT_RUN_ID
V7_0_E2E_EVAL_ARCHITECTURE_CLOSEOUT_STATUS = "V7_0_E2E_EVAL_ARCHITECTURE_CLOSEOUT_NONPROD_READY"
V7_0_1_PREMATURE_CLOSEOUT_AUDIT_V64_RECOVERY_SHORT_KEY = (
    "v7_0_1_premature_closeout_audit_and_v6_4_recovery_nonprod"
)
V7_0_1_PREMATURE_CLOSEOUT_AUDIT_V64_RECOVERY_SHORT_RUN_ID = (
    V7_0_1_PREMATURE_CLOSEOUT_AUDIT_V64_RECOVERY_SHORT_KEY
)
V7_0_1_PREMATURE_CLOSEOUT_AUDIT_V64_RECOVERY_LONG_RUN_ID = (
    V7_0_1_PREMATURE_CLOSEOUT_AUDIT_V64_RECOVERY_SHORT_RUN_ID
)
V7_0_1_PREMATURE_CLOSEOUT_AUDIT_V64_RECOVERY_STATUS = (
    "V7_0_1_PREMATURE_CLOSEOUT_AUDIT_AND_V6_4_RECOVERY_NONPROD_READY"
)
...
NEC_2026_LOCAL_ELECTION_XLSX_STATUS = (
    "NEC_2026_LOCAL_ELECTION_XLSX_SOURCE_COLLECTION_DIAGNOSTIC_NONPROD_READY"
)
...
RUNS: dict[str, RunMetadata] = {
    ...
    V5_7_VECTOR_LLM_CANDIDATE_ROUTING_SHORT_KEY: RunMetadata(
        logical_key=V5_7_VECTOR_LLM_CANDIDATE_ROUTING_SHORT_KEY,
        short_run_id=V5_7_VECTOR_LLM_CANDIDATE_ROUTING_SHORT_RUN_ID,
        canonical_long_run_id=V5_7_VECTOR_LLM_CANDIDATE_ROUTING_LONG_RUN_ID,
        status=V5_7_VECTOR_LLM_CANDIDATE_ROUTING_STATUS,
        short_report_path=REPORT_ROOT / "runs" / V5_7_VECTOR_LLM_CANDIDATE_ROUTING_SHORT_KEY / "report.json",
        accepted_aliases=(V5_7_VECTOR_LLM_CANDIDATE_ROUTING_SHORT_RUN_ID,),
        canonical_fields=("short_run_id", "canonical_long_run_id"),
    ),
    V5_7_1_RETRIEVAL_METRIC_INTEGRITY_AUDIT_SHORT_KEY: RunMetadata(
        logical_key=V5_7_1_RETRIEVAL_METRIC_INTEGRITY_AUDIT_SHORT_KEY,
        short_run_id=V5_7_1_RETRIEVAL_METRIC_INTEGRITY_AUDIT_SHORT_RUN_ID,
        canonical_long_run_id=V5_7_1_RETRIEVAL_METRIC_INTEGRITY_AUDIT_LONG_RUN_ID,
        status=V5_7_1_RETRIEVAL_METRIC_INTEGRITY_AUDIT_STATUS,
        short_report_path=REPORT_ROOT
        / "runs"
        / V5_7_1_RETRIEVAL_METRIC_INTEGRITY_AUDIT_SHORT_KEY
        / "report.json",
        accepted_aliases=(V5_7_1_RETRIEVAL_METRIC_INTEGRITY_AUDIT_SHORT_RUN_ID,),
        canonical_fields=("short_run_id", "canonical_long_run_id"),
    ),
    V5_7_2_LIVE_RETRIEVAL_DENOMINATOR_EXPANSION_SHORT_KEY: RunMetadata(
        logical_key=V5_7_2_LIVE_RETRIEVAL_DENOMINATOR_EXPANSION_SHORT_KEY,
        short_run_id=V5_7_2_LIVE_RETRIEVAL_DENOMINATOR_EXPANSION_SHORT_RUN_ID,
        canonical_long_run_id=V5_7_2_LIVE_RETRIEVAL_DENOMINATOR_EXPANSION_LONG_RUN_ID,
        status=V5_7_2_LIVE_RETRIEVAL_DENOMINATOR_EXPANSION_STATUS,
        short_report_path=REPORT_ROOT
        / "runs"
        / V5_7_2_LIVE_RETRIEVAL_DENOMINATOR_EXPANSION_SHORT_KEY
        / "report.json",
        accepted_aliases=(V5_7_2_LIVE_RETRIEVAL_DENOMINATOR_EXPANSION_SHORT_RUN_ID,),
        canonical_fields=("short_run_id", "canonical_long_run_id"),
    ),
    V5_8_RETRIEVAL_METRIC_EVALUATION_FRAMEWORK_SHORT_KEY: RunMetadata(
        logical_key=V5_8_RETRIEVAL_METRIC_EVALUATION_FRAMEWORK_SHORT_KEY,
        short_run_id=V5_8_RETRIEVAL_METRIC_EVALUATION_FRAMEWORK_SHORT_RUN_ID,
        canonical_long_run_id=V5_8_RETRIEVAL_METRIC_EVALUATION_FRAMEWORK_LONG_RUN_ID,
        status=V5_8_RETRIEVAL_METRIC_EVALUATION_FRAMEWORK_STATUS,
        short_report_path=REPORT_ROOT
        / "runs"
        / V5_8_RETRIEVAL_METRIC_EVALUATION_FRAMEWORK_SHORT_KEY
        / "report.json",
        accepted_aliases=(V5_8_RETRIEVAL_METRIC_EVALUATION_FRAMEWORK_SHORT_RUN_ID,),
        canonical_fields=("short_run_id", "canonical_long_run_id"),
    ),
    V6_0_TRUE_RAG_RETRIEVAL_REWRITE_SHORT_KEY: RunMetadata(
        logical_key=V6_0_TRUE_RAG_RETRIEVAL_REWRITE_SHORT_KEY,
        short_run_id=V6_0_TRUE_RAG_RETRIEVAL_REWRITE_SHORT_RUN_ID,
        canonical_long_run_id=V6_0_TRUE_RAG_RETRIEVAL_REWRITE_LONG_RUN_ID,
        status=V6_0_TRUE_RAG_RETRIEVAL_REWRITE_STATUS,
        short_report_path=REPORT_ROOT / "runs" / V6_0_TRUE_RAG_RETRIEVAL_REWRITE_SHORT_KEY / "report.json",
        accepted_aliases=(V6_0_TRUE_RAG_RETRIEVAL_REWRITE_SHORT_RUN_ID,),
        canonical_fields=("short_run_id", "canonical_long_run_id"),
    ),
    V6_0_AGENTIC_TRUE_RAG_TOOL_LOOP_SHORT_KEY: RunMetadata(
        logical_key=V6_0_AGENTIC_TRUE_RAG_TOOL_LOOP_SHORT_KEY,
        short_run_id=V6_0_AGENTIC_TRUE_RAG_TOOL_LOOP_SHORT_RUN_ID,
        canonical_long_run_id=V6_0_AGENTIC_TRUE_RAG_TOOL_LOOP_LONG_RUN_ID,
        status=V6_0_AGENTIC_TRUE_RAG_TOOL_LOOP_STATUS,
        short_report_path=REPORT_ROOT / "runs" / V6_0_AGENTIC_TRUE_RAG_TOOL_LOOP_SHORT_KEY / "report.json",
        accepted_aliases=(V6_0_AGENTIC_TRUE_RAG_TOOL_LOOP_SHORT_RUN_ID,),
        canonical_fields=("short_run_id", "canonical_long_run_id"),
    ),
    V6_1_TRUE_RAG_CORPUS_EXPANSION_METRIC_SPLIT_SHORT_KEY: RunMetadata(
        logical_key=V6_1_TRUE_RAG_CORPUS_EXPANSION_METRIC_SPLIT_SHORT_KEY,
        short_run_id=V6_1_TRUE_RAG_CORPUS_EXPANSION_METRIC_SPLIT_SHORT_RUN_ID,
        canonical_long_run_id=V6_1_TRUE_RAG_CORPUS_EXPANSION_METRIC_SPLIT_LONG_RUN_ID,
        status=V6_1_TRUE_RAG_CORPUS_EXPANSION_METRIC_SPLIT_STATUS,
        short_report_path=REPORT_ROOT
        / "runs"
        / V6_1_TRUE_RAG_CORPUS_EXPANSION_METRIC_SPLIT_SHORT_KEY
        / "report.json",
        accepted_aliases=(V6_1_TRUE_RAG_CORPUS_EXPANSION_METRIC_SPLIT_SHORT_RUN_ID,),
        canonical_fields=("run_id", "short_run_id", "canonical_long_run_id"),
    ),
    V6_2_SOURCE_DERIVED_MATERIALIZATION_SCALEOUT_SHORT_KEY: RunMetadata(
        logical_key=V6_2_SOURCE_DERIVED_MATERIALIZATION_SCALEOUT_SHORT_KEY,
        short_run_id=V6_2_SOURCE_DERIVED_MATERIALIZATION_SCALEOUT_SHORT_RUN_ID,
        canonical_long_run_id=V6_2_SOURCE_DERIVED_MATERIALIZATION_SCALEOUT_LONG_RUN_ID,
        status=V6_2_SOURCE_DERIVED_MATERIALIZATION_SCALEOUT_STATUS,
        short_report_path=REPORT_ROOT
        / "runs"
        / V6_2_SOURCE_DERIVED_MATERIALIZATION_SCALEOUT_SHORT_KEY
        / "report.json",
        accepted_aliases=(V6_2_SOURCE_DERIVED_MATERIALIZATION_SCALEOUT_SHORT_RUN_ID,),
        canonical_fields=("run_id", "short_run_id", "canonical_long_run_id"),
    ),
    V6_3_E2E_BGE_M3_FAISS_AGENTIC_RAG_SMOKE_SHORT_KEY: RunMetadata(
        logical_key=V6_3_E2E_BGE_M3_FAISS_AGENTIC_RAG_SMOKE_SHORT_KEY,
        short_run_id=V6_3_E2E_BGE_M3_FAISS_AGENTIC_RAG_SMOKE_SHORT_RUN_ID,
        canonical_long_run_id=V6_3_E2E_BGE_M3_FAISS_AGENTIC_RAG_SMOKE_LONG_RUN_ID,
        status=V6_3_E2E_BGE_M3_FAISS_AGENTIC_RAG_SMOKE_STATUS,
        short_report_path=REPORT_ROOT
        / "runs"
        / V6_3_E2E_BGE_M3_FAISS_AGENTIC_RAG_SMOKE_SHORT_KEY
        / "report.json",
        accepted_aliases=(V6_3_E2E_BGE_M3_FAISS_AGENTIC_RAG_SMOKE_SHORT_RUN_ID,),
        canonical_fields=("run_id", "short_run_id", "canonical_long_run_id"),
    ),
    V6_4_E2E_COVERAGE_FAILURE_TAXONOMY_SHORT_KEY: RunMetadata(
        logical_key=V6_4_E2E_COVERAGE_FAILURE_TAXONOMY_SHORT_KEY,
        short_run_id=V6_4_E2E_COVERAGE_FAILURE_TAXONOMY_SHORT_RUN_ID,
        canonical_long_run_id=V6_4_E2E_COVERAGE_FAILURE_TAXONOMY_LONG_RUN_ID,
        status=V6_4_E2E_COVERAGE_FAILURE_TAXONOMY_STATUS,
        short_report_path=REPORT_ROOT
        / "runs"
        / V6_4_E2E_COVERAGE_FAILURE_TAXONOMY_SHORT_KEY
        / "report.json",
        accepted_aliases=(V6_4_E2E_COVERAGE_FAILURE_TAXONOMY_SHORT_RUN_ID,),
        canonical_fields=("run_id", "short_run_id", "canonical_long_run_id"),
    ),
    V6_5_RETRIEVAL_METRIC_UNLOCK_PACKET_SHORT_KEY: RunMetadata(
        logical_key=V6_5_RETRIEVAL_METRIC_UNLOCK_PACKET_SHORT_KEY,
        short_run_id=V6_5_RETRIEVAL_METRIC_UNLOCK_PACKET_SHORT_RUN_ID,
        canonical_long_run_id=V6_5_RETRIEVAL_METRIC_UNLOCK_PACKET_LONG_RUN_ID,
        status=V6_5_RETRIEVAL_METRIC_UNLOCK_PACKET_STATUS,
        short_report_path=REPORT_ROOT
        / "runs"
        / V6_5_RETRIEVAL_METRIC_UNLOCK_PACKET_SHORT_KEY
        / "report.json",
        accepted_aliases=(V6_5_RETRIEVAL_METRIC_UNLOCK_PACKET_SHORT_RUN_ID,),
        canonical_fields=("run_id", "short_run_id", "canonical_long_run_id"),
    ),
    V6_5_1_GOLD29_ACTUAL_RESPONSE_SMOKE_SHORT_KEY: RunMetadata(
        logical_key=V6_5_1_GOLD29_ACTUAL_RESPONSE_SMOKE_SHORT_KEY,
        short_run_id=V6_5_1_GOLD29_ACTUAL_RESPONSE_SMOKE_SHORT_RUN_ID,
        canonical_long_run_id=V6_5_1_GOLD29_ACTUAL_RESPONSE_SMOKE_LONG_RUN_ID,
        status=V6_5_1_GOLD29_ACTUAL_RESPONSE_SMOKE_STATUS,
        short_report_path=REPORT_ROOT
        / "runs"
        / V6_5_1_GOLD29_ACTUAL_RESPONSE_SMOKE_SHORT_KEY
        / "report.json",
        accepted_aliases=(V6_5_1_GOLD29_ACTUAL_RESPONSE_SMOKE_SHORT_RUN_ID,),
        canonical_fields=("run_id", "short_run_id", "canonical_long_run_id"),
    ),
    V6_6_STRUCTURED_TOOL_OPERATION_TAXONOMY_SHORT_KEY: RunMetadata(
        logical_key=V6_6_STRUCTURED_TOOL_OPERATION_TAXONOMY_SHORT_KEY,
        short_run_id=V6_6_STRUCTURED_TOOL_OPERATION_TAXONOMY_SHORT_RUN_ID,
        canonical_long_run_id=V6_6_STRUCTURED_TOOL_OPERATION_TAXONOMY_LONG_RUN_ID,
        status=V6_6_STRUCTURED_TOOL_OPERATION_TAXONOMY_STATUS,
        short_report_path=REPORT_ROOT
        / "runs"
        / V6_6_STRUCTURED_TOOL_OPERATION_TAXONOMY_SHORT_KEY
        / "report.json",
        accepted_aliases=(V6_6_STRUCTURED_TOOL_OPERATION_TAXONOMY_SHORT_RUN_ID,),
        canonical_fields=("run_id", "short_run_id", "canonical_long_run_id"),
    ),
    V6_7_AGENTIC_RETRY_FAIL_CLOSED_POLICY_SHORT_KEY: RunMetadata(
        logical_key=V6_7_AGENTIC_RETRY_FAIL_CLOSED_POLICY_SHORT_KEY,
        short_run_id=V6_7_AGENTIC_RETRY_FAIL_CLOSED_POLICY_SHORT_RUN_ID,
        canonical_long_run_id=V6_7_AGENTIC_RETRY_FAIL_CLOSED_POLICY_LONG_RUN_ID,
        status=V6_7_AGENTIC_RETRY_FAIL_CLOSED_POLICY_STATUS,
        short_report_path=REPORT_ROOT
        / "runs"
        / V6_7_AGENTIC_RETRY_FAIL_CLOSED_POLICY_SHORT_KEY
        / "report.json",
        accepted_aliases=(V6_7_AGENTIC_RETRY_FAIL_CLOSED_POLICY_SHORT_RUN_ID,),
        canonical_fields=("run_id", "short_run_id", "canonical_long_run_id"),
    ),
    V6_8_METRIC_GATED_RETRIEVAL_QUALITY_ENGINEERING_SHORT_KEY: RunMetadata(
        logical_key=V6_8_METRIC_GATED_RETRIEVAL_QUALITY_ENGINEERING_SHORT_KEY,
        short_run_id=V6_8_METRIC_GATED_RETRIEVAL_QUALITY_ENGINEERING_SHORT_RUN_ID,
        canonical_long_run_id=V6_8_METRIC_GATED_RETRIEVAL_QUALITY_ENGINEERING_LONG_RUN_ID,
        status=V6_8_METRIC_GATED_RETRIEVAL_QUALITY_ENGINEERING_STATUS,
        short_report_path=REPORT_ROOT
        / "runs"
        / V6_8_METRIC_GATED_RETRIEVAL_QUALITY_ENGINEERING_SHORT_KEY
        / "report.json",
        accepted_aliases=(V6_8_METRIC_GATED_RETRIEVAL_QUALITY_ENGINEERING_SHORT_RUN_ID,),
        canonical_fields=("run_id", "short_run_id", "canonical_long_run_id"),
    ),
    V6_9_ANSWER_QUALITY_GATE_PACKET_SHORT_KEY: RunMetadata(
        logical_key=V6_9_ANSWER_QUALITY_GATE_PACKET_SHORT_KEY,
        short_run_id=V6_9_ANSWER_QUALITY_GATE_PACKET_SHORT_RUN_ID,
        canonical_long_run_id=V6_9_ANSWER_QUALITY_GATE_PACKET_LONG_RUN_ID,
        status=V6_9_ANSWER_QUALITY_GATE_PACKET_STATUS,
        short_report_path=REPORT_ROOT / "runs" / V6_9_ANSWER_QUALITY_GATE_PACKET_SHORT_KEY / "report.json",
        accepted_aliases=(V6_9_ANSWER_QUALITY_GATE_PACKET_SHORT_RUN_ID,),
        canonical_fields=("run_id", "short_run_id", "canonical_long_run_id"),
    ),
    V6_9_1_RETRIEVAL_SMOKE_PRE_REVIEW_PACKET_SHORT_KEY: RunMetadata(
        logical_key=V6_9_1_RETRIEVAL_SMOKE_PRE_REVIEW_PACKET_SHORT_KEY,
        short_run_id=V6_9_1_RETRIEVAL_SMOKE_PRE_REVIEW_PACKET_SHORT_RUN_ID,
        canonical_long_run_id=V6_9_1_RETRIEVAL_SMOKE_PRE_REVIEW_PACKET_LONG_RUN_ID,
        status=V6_9_1_RETRIEVAL_SMOKE_PRE_REVIEW_PACKET_STATUS,
        short_report_path=REPORT_ROOT
        / "runs"
        / V6_9_1_RETRIEVAL_SMOKE_PRE_REVIEW_PACKET_SHORT_KEY
        / "report.json",
        accepted_aliases=(V6_9_1_RETRIEVAL_SMOKE_PRE_REVIEW_PACKET_SHORT_RUN_ID,),
        canonical_fields=("run_id", "short_run_id", "canonical_long_run_id"),
    ),
    V7_0_E2E_EVAL_ARCHITECTURE_CLOSEOUT_SHORT_KEY: RunMetadata(
        logical_key=V7_0_E2E_EVAL_ARCHITECTURE_CLOSEOUT_SHORT_KEY,
        short_run_id=V7_0_E2E_EVAL_ARCHITECTURE_CLOSEOUT_SHORT_RUN_ID,
        canonical_long_run_id=V7_0_E2E_EVAL_ARCHITECTURE_CLOSEOUT_LONG_RUN_ID,
        status=V7_0_E2E_EVAL_ARCHITECTURE_CLOSEOUT_STATUS,
        short_report_path=REPORT_ROOT
        / "runs"
        / V7_0_E2E_EVAL_ARCHITECTURE_CLOSEOUT_SHORT_KEY
        / "report.json",
        accepted_aliases=(V7_0_E2E_EVAL_ARCHITECTURE_CLOSEOUT_SHORT_RUN_ID,),
        canonical_fields=("run_id", "short_run_id", "canonical_long_run_id"),
    ),
    V7_0_1_PREMATURE_CLOSEOUT_AUDIT_V64_RECOVERY_SHORT_KEY: RunMetadata(
        logical_key=V7_0_1_PREMATURE_CLOSEOUT_AUDIT_V64_RECOVERY_SHORT_KEY,
        short_run_id=V7_0_1_PREMATURE_CLOSEOUT_AUDIT_V64_RECOVERY_SHORT_RUN_ID,
        canonical_long_run_id=V7_0_1_PREMATURE_CLOSEOUT_AUDIT_V64_RECOVERY_LONG_RUN_ID,
        status=V7_0_1_PREMATURE_CLOSEOUT_AUDIT_V64_RECOVERY_STATUS,
        short_report_path=REPORT_ROOT
        / "runs"
        / V7_0_1_PREMATURE_CLOSEOUT_AUDIT_V64_RECOVERY_SHORT_KEY
        / "report.json",
        accepted_aliases=(V7_0_1_PREMATURE_CLOSEOUT_AUDIT_V64_RECOVERY_SHORT_RUN_ID,),
        canonical_fields=("run_id", "short_run_id", "canonical_long_run_id"),
    ),
    NEC_2026_LOCAL_ELECTION_XLSX_SHORT_KEY: RunMetadata(
        logical_key=NEC_2026_LOCAL_ELECTION_XLSX_SHORT_KEY,
        short_run_id=NEC_2026_LOCAL_ELECTION_XLSX_SHORT_RUN_ID,
        canonical_long_run_id=NEC_2026_LOCAL_ELECTION_XLSX_LONG_RUN_ID,
        status=NEC_2026_LOCAL_ELECTION_XLSX_STATUS,
        short_report_path=REPORT_ROOT / "runs" / NEC_2026_LOCAL_ELECTION_XLSX_SHORT_KEY / "report.json",
        accepted_aliases=(NEC_2026_LOCAL_ELECTION_XLSX_SHORT_RUN_ID,),
        canonical_fields=("short_run_id", "canonical_long_run_id"),
    ),
}
...
ALIAS_TO_KEY["current"] = V6_9_ANSWER_QUALITY_GATE_PACKET_SHORT_KEY
